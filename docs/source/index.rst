...
.. important::
   TML Is Based On the Belief that **"Fast data requires fast machine learning and AI for fast decision-making"** with faster ways to build advanced, scalable, cost- 
   effective and secure real-time solution by anyone.
