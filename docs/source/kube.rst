...
Scaling with NGINX Ingress
-------------------------

All TML solutions can be easily scaled using NGINX Ingress and Ingress controller.

Here is a sample Ingress YAML file: This file is auto-generated by the TSS for the TML solution: iotsolution-3f10
...
In the above YAML two NGINX paths are defined:
